      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
            ...
            />
            <Area type="monotone" dataKey="count" name="Visitantes" stroke="#00D4AA" strokeWidth={2} fill="url(#visitorsGrad)" />
            <Area type="monotone" dataKey="leads" name="Leads" stroke="#6366F1" strokeWidth={2} fill="url(#leadsGrad)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
